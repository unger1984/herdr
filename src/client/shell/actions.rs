    ...
    pub(super) fn record_binding(
        ...
        if matches!(
            ...
            crate::input::KeybindMatch::Action(
                crate::input::KeybindAction::SwitchWorkspace(_)
                    ...
                    | crate::input::KeybindAction::FocusPaneDown
                    | crate::input::KeybindAction::FocusPaneUp
                    ...
                    | crate::input::KeybindAction::LastPane
            )
        ) {
