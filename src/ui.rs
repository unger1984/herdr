...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        sidebar_status_block_height, sidebar_status_content_rect, sidebar_status_max_height,
        sidebar_status_rect, workspace_drop_slots, workspace_group_chevron_rect,
...
fn resize_sidebar_status(
    ...
    let status_area = sidebar_status_content_rect(app, sidebar_area);
